var FAQ = {
	...
	"items" : [
		...
		},
		{
			...
			"answer" : 'A. If you are saving for one or multiple employees it is highly recommended you rename these files in order to make it easier to keep track and store them for later use. <strong>(Click on the green SAVE button for a video tutorial)</strong><ul><li>Select SAVE button - this Saves the formData.txt to the Downloads folder</li><li>Using File Explorer, navigate to the saved file location in the Downloads folder. Use the refresh button to view the current file.</li><li>Rename the file as a NewFileName.txt. Each Save thereafter will create a new version of the file in the Downloads folder: NewFileName(1).txt</li></ul><br><a href="./SaveOnChrome" target="_blank">View Save On Chrome Video</a><br><a href="./SaveOnFirefox" target="_blank">View Save On FireFox Video</a>'
		},
		{
			"question" : "Q8.  How do I <STRONG>OPEN</STRONG> A saved document? ",
			"answer" : 'A.  Saving this form will save the file on your local computer. You can access the file via the File Explorer in order to move, or rename the file. Renaming is highly suggested so you know which employee the form is for. <strong>(Click the blue OPEN button for video tutorial)</strong><ul><li>Select Open button and Navigate to the New File Location/Name</li><li>Open the latest version of the saved file.</li></ul><br><a href="./OpenFile" target="_blank">View Open File Video</a>'
		},
		{
