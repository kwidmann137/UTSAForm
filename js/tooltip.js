var attributeDefinitions = {
	...
	'JUDGEMENT' : 'Analyzes situations; uses problem solviing skills; makes appropriate decisions consistent with the situation; obtains and evaluates pertinent information to determine source of and alternative solutions to problem',
	'QUANTITY & PRODUCTIVITY' : 'Accomodates multiple demands for commitment of time, energy and resources; develops and/or follows work procedures; handles information flow; organizes work assignments for optimum results; manages tiem and priorities appropriately',
...
var supervisorAttributeDefinitions = {
	...
	'LEADERSHIP' : 'Effectively conveys vision of unit goals; motivates employees to embrace the vision and contribute to unit/department success; serves as positive role model for employees; visibly supports Univeristy goals and mission and demonstrates dedication to the success of the organizationl effectively addresses conflicts; facilitates communcation; fosters productive work environment',
	'PROMOTES DIVERSITY' : 'Creates work environment which respects diveristy and welcomes new ideas; proactively works to achieve/maintain diverse workforce',
...
$(function(){
    $('button[value=O]').attr('data-toggle', 'tooltip');
    $('button[value=O]').attr('title', 'Outstanding: An employee rating as "Outstanding" consistnetly performs above that which is required. In addition, he/she may often make unique contributions and achieve exceptional accomplishments.');
    $('button[value=SP]').attr('data-toggle', 'tooltip');
    $('button[value=SP]').attr('title', 'Solid Performance: An employee rated in this category is a strong solid performer whose performance most often meets the requirements of the job. Occasionally, this employee may exceed expectations of the job. (This raitng may also be used for employees new in the position who have note yet acquired/demonstrated core competencies or may need some supervision or instruction).');
    $('button[value=I]').attr('data-toggle', 'tooltip');
    $('button[value=I]').attr('title', 'Improvement Needed: While this emnployee may meet expectations some of the time, the employee needs improvement in many of the significantly important requirements of the job or goals established for the year. A corrective action plan may be necessary to address performance and/or behavioral deficiencies.');
